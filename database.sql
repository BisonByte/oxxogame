...
--
-- Host: 127.0.0.1:3306
-- Generation Time: Aug 23, 2023 at 11:10 AM
...
--
-- Database: `u289937012_cashkingtest`
--
...
CREATE TABLE `games` (
  ...
  `points` int(3) NOT NULL DEFAULT 5,
  `game_time` int(10) NOT NULL DEFAULT 360
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
...
INSERT INTO `games` (`id`, `title`, `image`, `game`, `points`, `game_time`) VALUES
(1, 'Moto x3 war', 'https://img.cdn.famobi.com/portal/html5games/images/tmp/MotoX3mPoolPartyTeaser.jpg?v=0.2-c9592375', 'https://play.famobi.com/moto-x3m-pool-party', 5, 360),
(2, 'Archery world', 'https://img.cdn.famobi.com/portal/html5games/images/tmp/ArcheryWorldTourTeaser.jpg?v=0.2-c9592375', 'https://play.famobi.com/archery-world-tour', 5, 360),
(3, 'Totemia: cursed', 'https://img.cdn.famobi.com/portal/html5games/images/tmp/TotemiaCursedMarblesTeaser.jpg?v=0.2-c9592375', 'https://play.famobi.com/totemia-cursed-marbles', 5, 360),
(4, 'Jetpack joyride', 'https://img.cdn.famobi.com/portal/html5games/images/tmp/JetpackJoyrideTeaser.jpg?v=0.2-c9592375', 'https://play.famobi.com/jetpack-joyride', 5, 360),
(6, 'Zoo boom', 'https://img.cdn.famobi.com/portal/html5games/images/tmp/ZooBoomTeaser.jpg?v=0.2-6ecdaa3e', 'https://play.famobi.com/zoo-boom', 5, 360),
(7, 'Tower crash ', 'https://img.cdn.famobi.com/portal/html5games/images/tmp/TowerCrash3dTeaser.jpg?v=0.2-6ecdaa3e', 'https://play.famobi.com/tower-crash-3d', 5, 360),
(8, 'CANNON BALLS 3D', 'https://img.cdn.famobi.com/portal/html5games/images/tmp/CannonBalls3dTeaser.jpg?v=0.2-fb5e3a79', 'https://play.famobi.com/cannon-balls-3d', 5, 360);
...
INSERT INTO `offers` (`id`, `image`, `title`, `sub`, `offer_name`, `status`, `type`, `is_offer`, `points`) VALUES
(16, 'https://cash.hdcbbackground.com/img/20220730_231533.png206903163', 'AdGetMedia', 'Adgetmedia', 'adget', 0, 0, 0, 20),
(17, 'https://cash.hdcbbackground.com/img/20220730_231244.png1373133733', 'OfferToro', 'Win Coins', 'toro', 0, 0, 0, 30),
(18, 'https://cash.hdcbbackground.com/img/20220730_231709.jpg1948013955', 'ayeT-Studios', 'Win Coins', 'ayet', 0, 0, 0, 40),
(19, 'https://cash.hdcbbackground.com/img/applovin_max.png1646551417', 'Applovin Max', 'Get Coins', 'applovin', 0, 0, 1, 70),
(21, 'https://cash.hdcbbackground.com/img/Unity.png481857923', 'Unity', 'Get Coins', 'unity', 0, 0, 1, 40),
(34, 'https://cash.hdcbbackground.com/img/telegram.png2012229406', 'Join Telegram', 'Join telegram for payment proof', 'https://google.com/', 0, 1, 0, 50),
(36, 'https://cash.hdcbbackground.com/img/20220731_213557.png1820353714', 'ironSource', 'Reward AD', 'iron', 0, 0, 1, 30),
(37, 'https://cash.hdcbbackground.com/img/20220731_213557.png1871724338', 'ironSource', 'IronSource', 'iron_offer', 0, 0, 0, 60),
(38, 'https://cash.hdcbbackground.com/img/20220731_213244.png650962055', 'Adcolony', 'Adcolony', 'colony', 0, 0, 1, 20),
(41, 'https://cash.hdcbbackground.com/img/admob.png55377252', 'Admob', 'Get coins', 'admob', 0, 0, 1, 10),
(42, 'https://cash.hdcbbackground.com/img/vungle.png2141821728', 'Vungle', 'get coins', 'vungle', 0, 0, 1, 15),
(43, 'https://cash.hdcbbackground.com/img/startapp.png217850234', 'StartApp', 'get coins', 'startapp', 0, 0, 1, 25),
(46, 'https://cash.hdcbbackground.com/img/chartboost.png249290581', 'Chartboost', 'get coins', 'chartboost', 0, 0, 1, 35);
...
CREATE TABLE `settings` (
  ...
  `is_apps_enabled` varchar(5) NOT NULL DEFAULT 'false'
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
...
(66, 'tested', '100', 'Spin & Win Reward', '2023-08-22', '', '03:58 am');
